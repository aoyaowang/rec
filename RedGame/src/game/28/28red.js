 ...
 */
var game28red = ccui.Widget.extend({
    m_l1: null,
    ...
    onEnter:function() {
        this._super();
        Client.addMap("create28", this);
    },
    onExit:function() {
        this._super();
        Client.removeMap("create28", this);
    },
    btn1Click:function() {
    ...
    btnSend:function() {
        ...
        Server.gate("create28", {t: RoleInfo.token, type: this.m_subtype, coin: m});
    },
    create28:function(msg) {
