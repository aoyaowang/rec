...
var G28Player = GBasePlayer.extend({
    ...
    toJSON:function()
    {
        return {uid: this.uid, nickname: this.Info.nickname, gamename: this.Info.gamename, 
                headimg: this.Info.headimg, Room: this.m_Room.m_RoomID, qiang: this.m_Qiang, last: this.m_LastNum, result: this.m_Result, time: this.m_Time, pei: this.m_Pei, piao: this.m_Piao};
    },
    Qiang:function(q) {
